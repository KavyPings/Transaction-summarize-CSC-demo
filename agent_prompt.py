...
AGENT_ANALYZE_PROMPT = (
    ...
    "- <question 1>\n"
    "- <question 2>\n"
    "Generate up to 5 questions, each under 10 words, answerable from the data provided. "
...
AGENT_TRANSACTION_PROMPT = (
    ...
    "4. Recommendation\n"
    "   Exactly one of: APPROVE / RETURN FOR REVIEW / ESCALATE\n\n"
    "5. Justification\n"
    "   Concise bullet points supporting the recommendation\n\n"
    "QUESTIONS:\n"
    "- <question 1>\n"
    "- <question 2>\n"
    "Generate up to 5 short questions (each under 10 words) answerable from the data provided. "
...
AGENT_CHAT_PROMPT = (
    ...
    "answerable from the same context, one per line starting with '- '. Keep each under 10 words."
)

...
{
    [McpServerTool(Name = "ListKyc"), Description("List all KYC records with summary fields (id, fullName, nationality, riskRating, status, nextReviewDate, pep, sanctions).")]
    ...
    [McpServerTool(Name = "GetKyc"), Description("Get full KYC details for an individual — identity, occupation, source of funds/wealth, risk flags, screening results, status, and compliance notes.")]
